  ...
  return (
    ...
    >
      <div className="hero-title-reveal">
        <h1
          className="title-extrude font-[family-name:var(--font-devanagari)] text-[3.5rem] font-extrabold leading-[0.88] tracking-tight text-cream sm:text-[4.8rem] md:text-[6.4rem] lg:text-[9.1rem] xl:text-[10.15rem]"
          lang="hi"
        >
          माटी
          <br />
